...
### 1. 整体思路 现有多模态时序数据存在三种对齐关系。 现有方法分为 Early Fusion、Late Fusion 和 Non-Fusion 三类。TiMi 属于第三类——不依赖模态融合，而是将文本信息作为预测的指导信号。

![[Pasted image 20260610211208_01.png]]

![[Pasted image 20260610211208_02.png]] TiMi 的数据流为：

![[Pasted image 20260610211208_03.png]]
...
![[Pasted image 20260610211208_04.png]]
...
![[Pasted image 20260610211208_05.png]]
...
**TMoE（Text-informed MoE）：** 以文本表征 $\bar{H}$ 作为 Router 输入，门控网络 \in \mathbb{R}^{M \times \bar{D}}$ 生成路由权重，top-k 选择后加权组合共享 FFN 专家：
...
![[Pasted image 20260610211208_06.png]]
...
![[Pasted image 20260610211208_07.png]]
